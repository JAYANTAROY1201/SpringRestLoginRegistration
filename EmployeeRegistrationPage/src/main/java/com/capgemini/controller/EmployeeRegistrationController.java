...
import com.capgemini.service.GeneralEmpService;
...
public class EmployeeRegistrationController {
	...
	public ResponseEntity<String> login(@RequestBody EmployeeBean eb, UriComponentsBuilder ub) {
	...
	public ResponseEntity<String> signup(@RequestBody EmployeeBean eb, UriComponentsBuilder ub){
